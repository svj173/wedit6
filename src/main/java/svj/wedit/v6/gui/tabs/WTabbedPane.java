...
// Еще вариант - переписать класс Икон - чтобы иконка сама себя перерисовывала - в зеленый, красный. А его дергать по rewrite.
...
public class WTabbedPane extends JTabbedPane
{
    ...
    */
     ...
     * @since 1.4
     */
    public WTabbedPane (int tabPlacement, int tabLayoutPolicy) {
...
////////////////
    ...
    protected class AccessibleJTabbedPane extends AccessibleJComponent
        ...
        public AccessibleJTabbedPane() {
            super();
            WTabbedPane.this.model.addChangeListener(this);
        }
        ...
        public Accessible getAccessibleAt(Point p) {
            int tab = ((TabbedPaneUI) ui).tabForCoordinate ( WTabbedPane.this, p.x, p.y);
            if (tab == -1) {
    ...
    private class Page extends AccessibleContext
        ...
        void initAccessibleContext() {
            if (WTabbedPane.this.accessibleContext != null &&
        ...
        void setDisplayedMnemonicIndex(int mnemonicIndex) {
            if (this.mnemonicIndex != mnemonicIndex) {
                ...
                WTabbedPane.this.firePropertyChange("displayedMnemonicIndexAt",
                                                    null, null);
            }
        }
        ...
        void updateDisplayedMnemonicIndex() {
            int index = findDisplayedMnemonicIndex ( title, mnemonic );
            setDisplayedMnemonicIndex ( index );
        }

        private int findDisplayedMnemonicIndex ( String text, int mnemonic )
        {
