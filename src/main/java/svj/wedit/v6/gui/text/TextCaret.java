 ...
 * <BR/>
 * <BR/> Создать свой класс Caret с необходимой функциональностью; для экземпляра этого
 * своего класса вызвать install на требуемом JTextField'е.
 * В качестве основы можешь унаследоваться от DefaultCaret.
 * <BR/>
 * <BR/> User: svj
