...
public class TextPanel extends EditablePanel //implements Comparable<WPanel>
{
    ...
    /*
    -- ужее нет такого метода и где выключать - неизветсно. смао выключиться
