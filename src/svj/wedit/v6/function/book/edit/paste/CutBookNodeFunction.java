...
/**
 * Вырезать отмеченный обьект или несколько одноуровневых обьектов.
...
public class CutBookNodeFunction extends Function
{
    ...
    public void handle ( ActionEvent event ) throws WEditException
    {
        ...
        ic      = DialogTools.showConfirmDialog ( Par.GM.getFrame(), Convert.concatObj ( "Вырезать ", selectNodes.length, " элементов книги" ), label );
